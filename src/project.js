...
export default function projects() {
  return (
    <div className="projects d-none d-lg-block " style={{ marginTop: 20 }}>
      <h2>Projects</h2>
      {/* <br></br> */}

      <Row className="m-auto" style={{ marginTop: 100 }}>
        <Col>
          ...
          <div class="m-auto card border-success mb-3" style={{ width: 250 }}>
            ...
            <div class="card-body text-black">
              ...
              <p class="card-text">
                ...
                development environment called ganache .UI built using React and
                web3Js
              </p>
            </div>
